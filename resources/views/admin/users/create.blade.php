        ...
        <div class="main-content">
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(['method'=>'POST', 'class'=>'form-horizontal form-label-left', 'action'=> 'Admin\AdminUserController@store', 'files'=>true]) !!}
                        <div class="row">
                            <div class="col-sm-6 offset-sm-3">
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                    {!! Form::select('role_id', [''=>'Choose Roles'] + $roles, null, ['class'=>'form-control'])!!}
